...
class MockConfigViewModel extends ChangeNotifier
  ...
  @override
  List<String> get deviceIps =>
      List.unmodifiable(_deviceIps);
  @override
  bool get isLoading => _isLoading;
  @override
  String? get errorMessage => _errorMessage;
...
void main() {
  ...
  group('golden', () {
    testWidgets('home screen with devices',
        (tester) async {
      final vm = MockHomeViewModel();
      getIt
        ..registerSingleton<HomeViewModel>(vm)
        ..registerSingleton<SecureStorageService>(
          MockSecureStorageService(),
        )
        ..registerSingleton<TapoService>(
          MockTapoService(),
        );
    ...
    testWidgets('config screen with IPs',
        (tester) async {
